...
if __name__ == "__main__":
    ...
    while True:
        ...
        imgoutyard, humandetectyard = analyzeframe(img2, boxes2, scores2, classes2, num2, hfilteryd, fsize)         
        ...
        if humandetectyard == 1:
            lastlogtimeyd, dirtimeyd = humanevent(imgoutyard, timeelapyard, dirtimeyd, pb, pbipcam_channel, timebetweenevents, pbenabled, url, maindir, ydtext)
        # Resize the images
