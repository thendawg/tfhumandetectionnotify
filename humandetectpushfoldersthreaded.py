...
if __name__ == "__main__":
    ...
    while True:
        ...
        boxes2, scores2, classes2, num2 = odapi.processFrame(img2)
        ...
        imgoutyard, humandetectyard = analyzeframe(img2, boxes2, scores2, classes2, num2)         
        ...
        cv2.imwrite('output/RD/frontyardtmp.jpg', imgresizeyd, [cv2.IMWRITE_JPEG_PROGRESSIVE, 1,cv2.IMWRITE_JPEG_QUALITY, 80])
        ...
        print("Time since last frontyard log:", timeelapyard)
        sys.stdout.flush()
        end_time = time.time()
        ...
        shutil.copyfile('output/RD/frontyardtmp.jpg', 'output/RD/frontyard.jpg')
